...
export default {
	...
	"router": {
		...
		*/
		...
		"visitor" : [
			...
			"/pages/shop/index",
			"/pages/shop/type",
			"/pages/shop/goods_detail",
			"/pages/shop/cart",
			"/pages/marketing/integral/list",
			"/pages/marketing/integral/center",
			"/pages/marketing/integral/detail",
		],
		/*
		login:配置登录类型与优先级
	...
	"theme":"#FE8D2B"	//主题颜色 同uni.scss $uni-color-primary
}