...
const addInterceptor = defineSyncApi(API_ADD_INTERCEPTOR, (method2, interceptor) => {
  if (isString$1(method2) && isPlainObject$1(interceptor)) {
...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__00A1201",
    appName: "\u4E5D\u9E3F\u5546\u57CE\u5BA2\u6237\u7AEFuniapp\u7248",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  ...
  {
    path: "pages/shop/comment",
    style: {
      navigationBarTitleText: "\u5546\u54C1\u8BC4\u8BBA"
    }
  },
  {
    path: "pages/shop/comment_list",
    style: {
...
const subPackages = [
  ...
  },
  {
    ...
    pages: [
      ...
      {
        path: "distribution/apply",
        style: {
          navigationBarTitleText: "\u5206\u9500\u5546\u7533\u8BF7"
        }
      },
      {
      ...
      {
        path: "distribution/withdraw_log",
        style: {
      ...
      {
        path: "distribution/money-record",
        style: {
...
const tabBar = {
  ...
  list: [
    ...
    {
      pagePath: "pages/shop/type",
      iconPath: "static/tabbar/type.png",
      selectedIconPath: "static/tabbar/type-active.png",
      text: "\u5206\u7C7B"
    },
    {
...
let S;
S = _;
const k = m('{\n    "address": [\n        "127.0.0.1",\n        "10.10.10.150"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), I = m('[{"provider":"aliyun","spaceName":"shop-admin","spaceId":"mp-d5041a33-50ff-4269-b94f-167b240f0b07","clientSecret":"iVLmq3lZ+TJVNuCnQOj2WA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let T = "";
try {
  T = "__UNI__00A1201";
} catch (e2) {
...
(function(module2) {
  (function($2) {
    ...
    function md5cmn(q2, a2, b, x2, s2, t2) {
      return safeAdd(bitRotateLeft(safeAdd(safeAdd(a2, q2), safeAdd(x2, t2)), s2), b);
    }
    function md5ff(a2, b, c2, d2, x2, s2, t2) {
      return md5cmn(b & c2 | ~b & d2, a2, b, x2, s2, t2);
    }
    function md5gg(a2, b, c2, d2, x2, s2, t2) {
      return md5cmn(b & d2 | c2 & ~d2, a2, b, x2, s2, t2);
    }
    function md5hh(a2, b, c2, d2, x2, s2, t2) {
      return md5cmn(b ^ c2 ^ d2, a2, b, x2, s2, t2);
    }
    function md5ii(a2, b, c2, d2, x2, s2, t2) {
      return md5cmn(c2 ^ (b | ~d2), a2, b, x2, s2, t2);
    }
    function binlMD5(x2, len) {
      ...
      for (i2 = 0; i2 < x2.length; i2 += 16) {
        ...
        oldc = c2;
        oldd = d2;
        a2 = md5ff(a2, b, c2, d2, x2[i2], 7, -680876936);
        d2 = md5ff(d2, a2, b, c2, x2[i2 + 1], 12, -389564586);
        c2 = md5ff(c2, d2, a2, b, x2[i2 + 2], 17, 606105819);
        b = md5ff(b, c2, d2, a2, x2[i2 + 3], 22, -1044525330);
        a2 = md5ff(a2, b, c2, d2, x2[i2 + 4], 7, -176418897);
        d2 = md5ff(d2, a2, b, c2, x2[i2 + 5], 12, 1200080426);
        c2 = md5ff(c2, d2, a2, b, x2[i2 + 6], 17, -1473231341);
        b = md5ff(b, c2, d2, a2, x2[i2 + 7], 22, -45705983);
        a2 = md5ff(a2, b, c2, d2, x2[i2 + 8], 7, 1770035416);
        d2 = md5ff(d2, a2, b, c2, x2[i2 + 9], 12, -1958414417);
        c2 = md5ff(c2, d2, a2, b, x2[i2 + 10], 17, -42063);
        b = md5ff(b, c2, d2, a2, x2[i2 + 11], 22, -1990404162);
        a2 = md5ff(a2, b, c2, d2, x2[i2 + 12], 7, 1804603682);
        d2 = md5ff(d2, a2, b, c2, x2[i2 + 13], 12, -40341101);
        c2 = md5ff(c2, d2, a2, b, x2[i2 + 14], 17, -1502002290);
        b = md5ff(b, c2, d2, a2, x2[i2 + 15], 22, 1236535329);
        a2 = md5gg(a2, b, c2, d2, x2[i2 + 1], 5, -165796510);
        d2 = md5gg(d2, a2, b, c2, x2[i2 + 6], 9, -1069501632);
        c2 = md5gg(c2, d2, a2, b, x2[i2 + 11], 14, 643717713);
        b = md5gg(b, c2, d2, a2, x2[i2], 20, -373897302);
        a2 = md5gg(a2, b, c2, d2, x2[i2 + 5], 5, -701558691);
        d2 = md5gg(d2, a2, b, c2, x2[i2 + 10], 9, 38016083);
        c2 = md5gg(c2, d2, a2, b, x2[i2 + 15], 14, -660478335);
        b = md5gg(b, c2, d2, a2, x2[i2 + 4], 20, -405537848);
        a2 = md5gg(a2, b, c2, d2, x2[i2 + 9], 5, 568446438);
        d2 = md5gg(d2, a2, b, c2, x2[i2 + 14], 9, -1019803690);
        c2 = md5gg(c2, d2, a2, b, x2[i2 + 3], 14, -187363961);
        b = md5gg(b, c2, d2, a2, x2[i2 + 8], 20, 1163531501);
        a2 = md5gg(a2, b, c2, d2, x2[i2 + 13], 5, -1444681467);
        d2 = md5gg(d2, a2, b, c2, x2[i2 + 2], 9, -51403784);
        c2 = md5gg(c2, d2, a2, b, x2[i2 + 7], 14, 1735328473);
        b = md5gg(b, c2, d2, a2, x2[i2 + 12], 20, -1926607734);
        a2 = md5hh(a2, b, c2, d2, x2[i2 + 5], 4, -378558);
        d2 = md5hh(d2, a2, b, c2, x2[i2 + 8], 11, -2022574463);
        c2 = md5hh(c2, d2, a2, b, x2[i2 + 11], 16, 1839030562);
        b = md5hh(b, c2, d2, a2, x2[i2 + 14], 23, -35309556);
        a2 = md5hh(a2, b, c2, d2, x2[i2 + 1], 4, -1530992060);
        d2 = md5hh(d2, a2, b, c2, x2[i2 + 4], 11, 1272893353);
        c2 = md5hh(c2, d2, a2, b, x2[i2 + 7], 16, -155497632);
        b = md5hh(b, c2, d2, a2, x2[i2 + 10], 23, -1094730640);
        a2 = md5hh(a2, b, c2, d2, x2[i2 + 13], 4, 681279174);
        d2 = md5hh(d2, a2, b, c2, x2[i2], 11, -358537222);
        c2 = md5hh(c2, d2, a2, b, x2[i2 + 3], 16, -722521979);
        b = md5hh(b, c2, d2, a2, x2[i2 + 6], 23, 76029189);
        a2 = md5hh(a2, b, c2, d2, x2[i2 + 9], 4, -640364487);
        d2 = md5hh(d2, a2, b, c2, x2[i2 + 12], 11, -421815835);
        c2 = md5hh(c2, d2, a2, b, x2[i2 + 15], 16, 530742520);
        b = md5hh(b, c2, d2, a2, x2[i2 + 2], 23, -995338651);
        a2 = md5ii(a2, b, c2, d2, x2[i2], 6, -198630844);
        d2 = md5ii(d2, a2, b, c2, x2[i2 + 7], 10, 1126891415);
        c2 = md5ii(c2, d2, a2, b, x2[i2 + 14], 15, -1416354905);
        b = md5ii(b, c2, d2, a2, x2[i2 + 5], 21, -57434055);
        a2 = md5ii(a2, b, c2, d2, x2[i2 + 12], 6, 1700485571);
        d2 = md5ii(d2, a2, b, c2, x2[i2 + 3], 10, -1894986606);
        c2 = md5ii(c2, d2, a2, b, x2[i2 + 10], 15, -1051523);
        b = md5ii(b, c2, d2, a2, x2[i2 + 1], 21, -2054922799);
        a2 = md5ii(a2, b, c2, d2, x2[i2 + 8], 6, 1873313359);
        d2 = md5ii(d2, a2, b, c2, x2[i2 + 15], 10, -30611744);
        c2 = md5ii(c2, d2, a2, b, x2[i2 + 6], 15, -1560198380);
        b = md5ii(b, c2, d2, a2, x2[i2 + 13], 21, 1309151649);
        a2 = md5ii(a2, b, c2, d2, x2[i2 + 4], 6, -145523070);
        d2 = md5ii(d2, a2, b, c2, x2[i2 + 11], 10, -1120210379);
        c2 = md5ii(c2, d2, a2, b, x2[i2 + 2], 15, 718787259);
        b = md5ii(b, c2, d2, a2, x2[i2 + 9], 21, -343485551);
        a2 = safeAdd(a2, olda);
        b = safeAdd(b, oldb);
        c2 = safeAdd(c2, oldc);
        d2 = safeAdd(d2, oldd);
