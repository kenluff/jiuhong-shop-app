...
const pages_ucenter_loginPage_register_validator = require("./validator.js");
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    r: common_vendor.sr("form", "0548dcee-0"),
    s: common_vendor.p({
      value: $data.formData,
      rules: $data.rules,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/uniapp/\u4E5D\u9E3F\u5546\u57CE\u5BA2\u6237\u7AEFuniapp\u7248/pages/ucenter/login-page/register/register.vue"]]);
