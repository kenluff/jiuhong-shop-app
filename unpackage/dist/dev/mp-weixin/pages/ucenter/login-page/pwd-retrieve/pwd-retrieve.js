...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    d: common_vendor.sr("shortCode", "51db7429-5,51db7429-4"),
    e: common_vendor.p({
    ...
    s: common_vendor.sr("form", "51db7429-0"),
    t: common_vendor.p({
      value: $data.formData
    })
  };
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/uniapp/\u4E5D\u9E3F\u5546\u57CE\u5BA2\u6237\u7AEFuniapp\u7248/pages/ucenter/login-page/pwd-retrieve/pwd-retrieve.vue"]]);
