	...
	<view :id="attrs.id" :class="'_'+name+' '+attrs.class" :style="attrs.style">
		<block v-for="(n, i) in childs" v-bind:key="i">
			...
			<view v-else-if="n.name=='a'" :id="n.attrs.id" :class="(n.attrs.href?'_a ':'')+n.attrs.class" hover-class="_hover" :style="'display:inline;'+n.attrs.style" :data-i="i" @tap.stop="linkTap">
			  <node-item name="span" :childs="n.children" :opts="opts" style="display:inherit" />
			</view>
			...
			<view v-else-if="(n.name=='table'&&n.c)||n.name=='li'" :id="n.attrs.id" :class="'_'+n.name+' '+n.attrs.class" :style="n.attrs.style">
			  <node-item v-if="n.name=='li'" :childs="n.children" :opts="opts" />
			  <view v-else v-for="(tbody, x) in n.children" v-bind:key="x" :class="'_'+tbody.name+' '+tbody.attrs.class" :style="tbody.attrs.style">
			    <node-item v-if="tbody.name=='td'||tbody.name=='th'" :childs="tbody.children" :opts="opts" />
			    <block v-else v-for="(tr, y) in tbody.children" v-bind:key="y">
			      <view v-if="tr.name=='td'||tr.name=='th'" :class="'_'+tr.name+' '+tr.attrs.class" :style="tr.attrs.style">
			        <node-item :childs="tr.children" :opts="opts" />
			      </view>
			      <view v-else :class="'_'+tr.name+' '+tr.attrs.class" :style="tr.attrs.style">
			        <view v-for="(td, z) in tr.children" v-bind:key="z" :class="'_'+td.name+' '+td.attrs.class" :style="td.attrs.style">
			          <node-item :childs="td.children" :opts="opts" />
			        </view>
			      </view>
			    </block>
			  </view>
			...
			<view v-else-if="n.c==2" :id="n.attrs.id" :class="'_'+n.name+' '+n.attrs.class" :style="n.f+';'+n.attrs.style">
			  <node-item v-for="(n2, j) in n.children" v-bind:key="j" :style="n2.f" :name="n2.name" :attrs="n2.attrs" :childs="n2.children" :opts="opts" />
			</view>
			<node-item v-else :style="n.f" :name="n.name" :attrs="n.attrs" :childs="n.children" :opts="opts" />
		</block>
	</view>
</view>
